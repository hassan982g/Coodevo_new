...
accordions.forEach((item) => {
  var label = item.querySelector(".accordion-header");
...
progressBars.forEach((progressBar) => {
  ...
  var percentageValue = progressBar.getAttribute("data-percentage-value");
...
function showImage(event) {
  var hoverOnItem = event.currentTarget;
  var hoverOnImage = hoverOnItem.querySelector(".hover-on-image");
  var hoveredImage = document.getElementById("hoveredImage");
...
// =========== Project Slider - 1 =============
// var projectSliderOne = new Swiper(".projectSliderOne", {
//   slidesPerView: 1,
//   pagination: {
...
// =========== Project Slider - 2 =============
var projectSliderTwo = new Swiper(".projectSliderTwo", {
  slidesPerView: 1,
  spaceBetween: 24,
  breakpoints: {
    768: {
...
// =========== Project Slider - 3 =============
var projectSliderThree = new Swiper(".projectSliderThree", {
  slidesPerView: 1,
  spaceBetween: 24,
  scrollbar: {
    el: ".swiper-scrollbar",
...
// =========== Project Slider - 4 =============
var projectSliderFour = new Swiper(".projectSliderFour", {
  pagination: {
    el: ".swiper-pagination",
    type: "fraction",
  },
...
var clientSliderTwo = new Swiper(".client-slider-2", {
  slidesPerView: 1,
  loop: true,
  speed: 5000,
  autoplay: {
...
var clientSliderThree = new Swiper(".client-slider-3", {
  slidesPerView: 1,
  loop: true,
  speed: 5000,
  autoplay: {
...
var testimonialSliderOne = new Swiper(".testimonial-slider-1", {
  // Optional parameters
  loop: true,
...
var testimonialSlideTwo = new Swiper(".testimonial-slider-2", {
  // Optional parameters
  loop: true,
});

var testimonialSlideThree = new Swiper(".testimonial-slider-3", {
  // Optional parameters
  loop: true,
  slidesPerView: 1,
  spaceBetween: 24,
...
// =========== Service Slider - 1 =============
var serviceSliderOne = new Swiper(".service-slider-one", {
  slidesPerView: 1,
  loop: true,
  spaceBetween: 30,
  // Navigation arrows
...
// =========== Home-9: Hero Slide =============
var hero9Slider = new Swiper(".hero-9-slider", {
  loop: true,
  speed: 5000,
  spaceBetween: 24,
  slidesPerView: 2,
...
var hero9SliderReverse = new Swiper(".hero-9-slider-reverse", {
  loop: true,
  speed: 5000,
  spaceBetween: 24,
  slidesPerView: 2,
